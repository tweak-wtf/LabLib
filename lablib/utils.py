...
#     if not result["origin_x"]:
#         result["origin_x"] = 0
#     if not result["origin_y"]:
#         result["origin_y"] = 0
#     if not result["timecode"]:
#         result["timecode"] = default_timecode
#     if not result["fps"]:
#         result["fps"] = default_fps
#     if not result["par"]:
#         result["par"] = default_par
